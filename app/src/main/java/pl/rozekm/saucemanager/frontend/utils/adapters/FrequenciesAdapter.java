...
public class FrequenciesAdapter extends ArrayAdapter<Frequency> {
    ...
    public FrequenciesAdapter(Context context, int textViewResourceId, ArrayList<Frequency> values) {
